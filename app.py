...
########################################################################################################################################################################################################################################################################
def generate_arsenal_data(n_samples=None, dataset=None, noise=None):
...
def update_svm_graph(
    ...
    # Data Pre-processing
    # X, y = generate_arsenal_data(n_samples=sample_size, dataset=dataset, noise=noise)
